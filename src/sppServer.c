...
extern QueueHandle_t SPPconQueue;
...
static void esp_spp_cb(esp_spp_cb_event_t event, esp_spp_cb_param_t *param)
{
    ...
    switch (event)
    {
        ...
        case ESP_SPP_CLOSE_EVT:
            /* Switch the stdout back to normal console output when the SPP connection closes */
        ...
        case ESP_SPP_WRITE_EVT:
            // Don't print anything in this event, it will make an endless loop trying to write data to the SPP.
        ...
        case ESP_SPP_SRV_OPEN_EVT:
            ...
            /* Redirect the stdout to the SPP connection */
        ...
        default:
            ESP_LOGW(SPP_TAG, "Unhandled SPP event: %d", event);
            break;
    }
}
...
void esp_bt_gap_cb(esp_bt_gap_cb_event_t event, esp_bt_gap_cb_param_t *param)
{
    ...
    switch (event)
    {
        ...
        default:
            ESP_LOGW(SPP_TAG, "Unhandled GAP event: %d", event);
            break;
    }
    return;
}
